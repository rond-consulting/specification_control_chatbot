...
# Set the path to the combined certificate bundle if you've created one
os.environ['SSL_CERT_FILE'] = 'path/to/combined_cert.pem'

# If using proxy settings
openai.proxy = {
    "http": "http://proxy.yourcompany.com:port",
    "https": "http://proxy.yourcompany.com:port",
}
